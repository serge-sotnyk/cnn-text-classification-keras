...
labels = []
texts = []
with open(pos_file, "rt", encoding='cp1252') as f:
    for line in f:
        labels.append('pos')
        texts.append(line.strip())

with open(neg_file, "rt", encoding='cp1252') as f:
    for line in f:
        labels.append('neg')
        texts.append(line.strip())
...
model = kimCNN(EMBEDDING_DIM, MAX_SEQUENCE_LENGTH, MAX_NB_WORDS, embeddings_index, word_index,
